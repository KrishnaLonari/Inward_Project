...
import com.api.remitGuru.component.domain.GetSingxFxDaemon;
import com.api.remitGuru.component.util.Logger;

public class GetSingxGetFxDaemonJob implements Job {
	public void execute(JobExecutionContext arg0) throws JobExecutionException
	{
		try
		{
			...
			GetSingxFxDaemon singxFXGetQuote = new GetSingxFxDaemon();
			singxFXGetQuote.executeGetRationalFXGetQuoteDtlsDaemon();
